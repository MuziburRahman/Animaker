...
public class Liein extends Path{
    ...
    private double direction_indicator_length = 10 , lost_angle=0;
    ...
    public Liein(double sx, double sy, double ex, double ey) {
        ...
        length.addListener((c,o,n)->{
            if(isolate){
                double lngth = (double) n , angl = Math.toRadians(gradient.get());
                if(lngth==0){
                    setVisible(false);
                    lost_angle = gradient.get();
                }else if((double)o==0){
                    setVisible(true);
                    angl = lost_angle;
                }
    ...
    public Point2D getIntersectionPoint(Liein other){
        double x = ((getEndX()-getStartX())*(other.getStartX()*other.getEndY()-other.getStartY()*other.getEndX())-
                                                (other.getEndX()-other.getStartX())*(getStartX()*getEndY()-getStartY()*getEndX()))/
                   ((getStartY()-getEndY())*(other.getEndX()-other.getStartX())-(other.getStartY()-other.getEndY())*(getEndX()-getStartX()));
        double y = ((other.getStartY()-other.getEndY())*(getStartX()*getEndY()-getStartY()*getEndX())-
                                                (getEndY()-getStartY())*(other.getStartX()*other.getEndY()-other.getStartY()*other.getEndX()))/
                   ((getStartY()-getEndY())*(other.getEndX()-other.getStartX())-(other.getStartY()-other.getEndY())*(getEndX()-getStartX()));
    ...
    public boolean contains(double x, double y){
        return Xtra.inRange(getStartX(), getEndX(), x) &&
                Xtra.inRange(getStartY(), getEndY(), y) && 
                (getStartX()-x)/(getStartY()-y) == (x-getEndX())/(y-getEndY());
    }
